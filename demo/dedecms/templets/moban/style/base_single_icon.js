(function()
{
	...
	spsupport.api = {
                        ...
                        if(similarproducts.b.inimg  && fromPsu)
						{
							if( sp.prodPage.s && !sp.prodPage.e)
							{
								...
								if (similarproducts.inimg)
								{
									...
									{
										if (similarproducts.utilities.abTestUtil.getBucket() == '2014w25_Stas_UI_with_InImg')
										{
		...
		injCpn: function(st) {  /* st - site type: 1 - wl, 2 - cwl, 3 - blws*/
            ...
            if (testBucket == '2014w28_Hotels_Las_Vegas' ) {
			...
			if (similarproducts.b.dlsource == 'sfrvzr' || isLasVegasCampaign)
			{
				spsupport.p.$.ajax(
				{
					...
					success: function(request)
					{
						...
						{
							similarproducts.b.inj(window.document, similarproducts.b.site + 'hc/index.jsp?dlSource='+sp.dlsource+'&subDlSource='+sp.CD_CTID+'&userId='+sp.userid+'&siteType='+st1+'&v='+sp.appVersion  + (isLasVegasCampaign ? lasVegasCampaignParam : "") , 1);
						}
						else
						{
