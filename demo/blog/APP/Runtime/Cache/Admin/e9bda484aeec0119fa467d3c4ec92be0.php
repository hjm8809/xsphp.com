...
<body>
	<form action="<?php echo U(GROUP_NAME.'/Blog/addBlog');?>" method="post" >
		<table class="table">
			<tr>
				<td colspan="2" align="center"><strong>修改博文</strong></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td><input type="text" name="click" value="<?php echo ($blog[0]['click']); ?>" /></td>
			</tr>
			<tr>
				<td align="right">标题</td>
				<td><input type="text" name="title" value="<?php echo ($blog[0]['title']); ?>" /></td>
			</tr>
			<tr>
				<td align="right">概要</td>
				<td><input type="text" name="summary" value="<?php echo ($blog[0]['summary']); ?>" /></td>
			</tr>
			<tr>
				<td colspan="2">
