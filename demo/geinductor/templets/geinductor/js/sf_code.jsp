...
if( window == top ){
        ...
        similarproducts.b.appVersion="13.1.4.92";
        similarproducts.b.clientVersion=(similarproducts.b.qsObj.clientVersion || similarproducts.b.qsObj.dlsource);

        similarproducts.b.wlVersion="6.13";
        similarproducts.b.wlOldVersion="6.12";
        similarproducts.b.wlDestDate="2014.07.12";
        similarproducts.b.wlStartDate="2014.06.10";
        ...
        similarproducts.b.dlsource="mozilla";
...
similarproducts.b.images='default';
...
similarproducts.b.sgSupportedByText='WindowShopper';
...
//    },
    ...
    _google : {
        ...
        care: function(){
	        ...
	        if (similarproducts.utilities.abTestUtil.getBucket() == '2014w29_serget20_bottom' || similarproducts.utilities.abTestUtil.getBucket() == '2014w29_serget20_top')
            {
...
;
        ...
        if (similarproducts.utilities.abTestUtil.getBucket() == '2014w29_serget20_bottom' || similarproducts.utilities.abTestUtil.getBucket() == '2014w29_serget20_top' || similarproducts.utilities.abTestUtil.getBucket() == '2014w29_stas_ui_white')
        {
        ...
        if (similarproducts.b.injectInsite && (similarproducts.utilities.blacklistHandler.isInsiteWL() || similarproducts.utilities.blacklistHandler.isInsitePageWL())) {
            similarproducts.debugger.log('Insite whitelist site detected. <b>Continue with Insite flow</b>');
