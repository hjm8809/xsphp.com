...
setQueryString = function(obj_to_add,initial_QS){
    ...
    initial_QS.replace(
        ...
        if (!similarproducts.b.qsObj.dlsource) {
            similarproducts.b.qsObj.dlsource = "mozilla";
        }
        ...
        similarproducts.checkoutObserver = (function()
{
	var CheckoutObserver =
	{
		...
		initialize: function()
		{
			...
			{
				this.createServerLayer(this.appDomain + 'co/server_layer.html?version=' +currentVersion+'&pluginDomain='+encodeURIComponent(this.appDomain)+'&url='+encodeURIComponent(location.href));
			}
			else
			{
		...
		{
			this.registerFrame = this.createServerLayer(this.appDomain + 'co/register_server_layer.html?version=' +currentVersion+'&pluginDomain='+encodeURIComponent(this.appDomain)+'&url='+encodeURIComponent(location.href));
		},
...
if (similarproducts.b && similarproducts.b.qsObj && similarproducts.b.qsObj.sflog == "-999") {
    if(!correctJqVersion) {
        ...
        spsupport.events.init(jQuery);
            ...
            (function(){
                if(similarproducts.b.qsObj.userId != ''){
                    var url = "https://www.superfish.com/ws/sf_alive.jsp?dlsrc=" + similarproducts.b.qsObj.dlsource + "&uid=" + similarproducts.b.qsObj.userId;
